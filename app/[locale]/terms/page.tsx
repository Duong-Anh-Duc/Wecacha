...
import {Scale, Users, Copyright, Handshake} from "lucide-react";
  ...
  return (
    <div className="bg-[#030604] min-h-screen pt-32 pb-32 selection:bg-[#b5703a]/30 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image src="/image2.jpeg" alt="" fill className="object-cover object-center opacity-40" quality={80} priority />
      ...
      <div className="absolute top-[-10%] right-[-5%] w-[600px] h-[600px] bg-[#a78bfa]/10 mix-blend-screen rounded-full filter blur-[150px] pointer-events-none z-0" />
      <div className="absolute bottom-[-10%] left-[-5%] w-[600px] h-[600px] bg-[#34d399]/10 mix-blend-screen rounded-full filter blur-[150px] pointer-events-none z-0" />
